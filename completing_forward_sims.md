...
# Completing forward simulations

The ``msprime`` simulator generates tree sequences using the backward-in-time
coalescent model. But it is also possible to output tree sequences
